...
class _CAA_result:
    ...
    def _plot(self,plot_type, attributes, archetype_number, types, weighted, subject_indexes, save_figure, filename):
        ...
        if plot_type == "PCA_scatter_plot":
            ...
            self.plots._attribute_scatter_plot(self.Z,self.X_hat,attributes,self.type,self.p)
            ...
            self.plots._barplot_all(self.Z,self.columns, self.type, self.p)
        elif plot_type == "typal_plot":
            self.plots._typal_plot(self.Z,types,weighted)
        elif plot_type == "pie_chart":
            self.plots._pie_chart(self.A,subject_indexes)
        elif plot_type == "attribute_distribution":
            self.plots._attribute_distribution(self.A,self.Z,subject_indexes,self.columns,self.p,self.type)
